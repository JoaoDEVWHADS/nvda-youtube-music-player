...
|----------|---------------|
| 🇺🇸 English | [Read Documentation](readme.md) |
| 🇧🇷 Português | [Leia a Documentação](readme_pt.md) |
| 🇪🇸 Español | [Leer Documentación](readme_es.md) |
| 🇫🇷 Français | [Lire la Documentation](readme_fr.md) |
| 🇩🇪 Deutsch | [Dokumentation lesen](readme_de.md) |
| 🇮🇹 Italiano | [Leggi la Documentazione](readme_it.md) |
| 🇷🇺 Русский | [Читать документацию](readme_ru.md) |
| 🇯🇵 日本語 | [ドキュメントを読む](readme_ja.md) |
| 🇨🇳 中文 | [阅读文档](readme_zh.md) |
| 🇹🇷 Türkçe | [Belgeleri Oku](readme_tr.md) |
| 🇸🇦 العربية | [اقرأ الوثائق](readme_ar.md) |
